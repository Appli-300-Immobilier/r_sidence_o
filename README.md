# R�sidence O - Plateforme Immobilière Premium

Bienvenue sur le dépôt du code source de l'application web **R�sidence O**. Ce projet est une solution complète (Site Vitrine + Catalogue de Biens + Administration) développée avec des technologies modernes pour le secteur de l'immobilier en Cameroun.
...
* **Email :** contact@rsidenceo.cm
* **Social :** [Facebook](https://www.facebook.com/residenceo) | [WhatsApp](https://wa.me/237600000000)
